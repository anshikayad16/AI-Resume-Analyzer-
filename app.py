...
#Footer
st.markdown("---")
st.markdown("""<p style= 'text-align: center;' >Powered by <b>Streamlit</b> and <b>Google Gemini AI</b> | Developed by <a href="https://www.linkedin.com/in/anshika-yadav-58b371282/"  target="_blank" style='text-decoration: none; color: #FFFFFF'><b>Anshika Yadav</b></a></p>""", unsafe_allow_html=True)
